...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Liquid Glass Color Palette inspired by Crextio
        primary: {
          50: '#fffbeb',
          100: '#fef3c7',
          200: '#fde68a',
      ...
      backgroundImage: {
        'gradient-glass-light': 'linear-gradient(135deg, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0.1) 100%)',
        ...
        'gradient-surface': 'linear-gradient(135deg, #fafafa 0%, #f4f4f5 100%)',
      },
      backdropBlur: {
        xs: '2px',
        sm: '4px',
      ...
      boxShadow: {
        ...
        'warm': '0 10px 25px -3px rgba(251, 191, 36, 0.1), 0 4px 6px -2px rgba(251, 191, 36, 0.05)',
        'warm-lg': '0 20px 35px -3px rgba(251, 191, 36, 0.15), 0 8px 15px -2px rgba(251, 191, 36, 0.1)',
      },
      animation: {
